// ============================================================
//  ui.js — Catégories, Promotions, Témoignages
//  Règle : reçoit des données en paramètre, ne fait JAMAIS fetch()
// ============================================================

/**
 * Affiche les boutons de catégorie dans la sidebar et la barre de filtres
 */
...
/**
 * Affiche les bandeaux de promotion
 */
...
/**
 * Met à jour l'indicateur de statut API dans le header
 */
function setApiStatus(etat) {
  const dot = document.querySelector('#api-status');
  if (!dot) return;
  dot.className = 'api-dot ' + etat; // 'loading' | 'ok' | 'error'
